...
$(document).bind( "pageinit", function( e, data ) {
	...
	$(".items").live("swiperight",function(event) {
		...
		$.post('process.php', {'action':'remove', 'id':$(this).attr('item_id')}, function(t){ 
			$.post('process.php', {'action':'show_inactive'}, function(t){ 
	...
	$(".inactive-items").live("swipeleft",function(event) { 
		...
		$.post('process.php', {'action':'delete', 'id':$(this).attr('item_id')}, function(t){ 
